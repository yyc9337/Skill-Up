...
/*COMMON*/
	...
	var List = "<spring:message code='term.list'/>";
</script>
	...
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline font-size-base">
				<h5 class="card-title font-size-lg"><strong><spring:message code="term.list"/></strong></h5>
			...
			<div class="form-group row font-size-xs" style="margin-left: 10px;">
					<select class="form-control font-size-xs" aria-hidden="true" style="width: 150px; margin-left: 10px;" name="searchType" id="searchType">
						<option value="all"><spring:message code="term.all"/></option>
					</select>
					<div class="col-lg-9">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title"><strong id="modalTitle"><spring:message code="term.create"/></strong></h3>
				...
				<form action="#" class="form-horizontal" id="insert_form">
					<div class="modal-body">
						<div class="form-group row" id="compositionDiv">
							<div class="col-12">
								<label><spring:message code="term.wordselect"/><text class="text-danger">*</text></label>
...
<%--							</div>--%>
						...
						<div class="form-group row">
								<div class="col-sm-12">
									<label><spring:message code="term.termDescription"/></label>
