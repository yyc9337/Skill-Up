	...
	<div class="content">
		<div class="card">
			...
			<div class="form-group row font-size-xs" style="margin-left: 10px;">
					...
					<button class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 font-size-xs" type="button" id="historyButton" onclick="Delete_History();" style="margin-right: 5px;">삭제 기록</button>
					<button class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 font-size-xs" type="button" id="outrevivalButton" onclick="History_out();" style="margin-right: 5px;">용어 목록</button>
					<button class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 font-size-xs" type="button" onclick="modalOn('Create');" id="insertButton" style="margin-right:30px;">신규 등록</button>
					<!--  -->
			</div>
			</form>
...
<%--							</div>--%>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn bg-teal" id="modalConfirmButton" onclick="saveConfirm();">저장</button>
						 <button type="button" class="btn bg-teal" id="revivalButton" onclick="revivalConfirm();">복원</button>
						 <button type="button" class="btn bg-teal" id="deleteButton" onclick="deleteConfirm();">삭제</button>
